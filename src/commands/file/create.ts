...
export default class Create extends Command {
  ...
  //   name: { char: 'n', type: 'string', description: 'name to print', required: true },
...
`<apex:page id="${name}" lightningStylesheets="true">
  ...
  <script src="/resource/${name}/App.bundle.js" type="text/javascript"></script>
    ...
    const templateResourceMetadata =
...
<ApexPage xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    return Promise.all([
      createDirectoryPromise(`force-app/main/default/pages/${name}/src/components`),
    ...
    .then(() =>
      Promise.all([
        ...
        writeToFile(`force-app/main/default/pages/${name}/src/index.js`, templateIndex),
        writeToFile(`force-app/main/default/pages/${name}/src/components/App.js`, templateApp),
        writeToFile(`force-app/main/default/pages/${name}.page`, templateIndexHtml),
        writeToFile(`force-app/main/default/staticresources/${name}.resource-meta.xml`, templateResourceMetadata),
        writeToFile(`force-app/main/default/pages/${name}.page-meta.xml`, templatePageMetadata)
      ]).then(results => {
